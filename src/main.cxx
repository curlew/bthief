...
int main() {
    ...
    auto appdata_local = find_folder(FOLDERID_LocalAppData);
    // auto appdata_roaming = find_folder(FOLDERID_RoamingAppData);

    auto browsers = std::to_array<std::pair<std::string, std::unique_ptr<browser>>>({
